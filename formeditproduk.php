...
<body>
  ...
  <div align="center">
    <fieldset>
      ...
      <form action="editproduk.php" method="post" name="form1" id="form1">
        <table>
          <tr>
            <td>NAMA PRODUK</td>
            <td>
              <input type="hidden" value="<?php echo "$_GET[idnya]" ?>" name="ProdukId">
              <input type="text" name="produk" id="produk" value="<?php echo "$array[NamaProduk]" ?>">
            </td>
          </tr>
          <tr>
            <td>HARGA</td>
            <td><input type="text" name="harga" id="harga" value="<?php echo "$array[Harga]" ?>"></td>
          </tr>
          <tr>
            <td>STOK</td>
            <td><input type="text" name="stok" id="stok" value="<?php echo "$array[Stok]" ?>"></td>
          </tr>
          <tr>
