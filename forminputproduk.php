  ...
  <body>
    ...
    <fieldset>
      ...
      <table border="1" cellspacing="0" cellpadding="10">
        ...
        <?php
        $no = 1;
        $ambil = mysqli_query($koneksi, "SELECT * FROM produk ORDER BY 
NamaProduk asc");
        while ($array = mysqli_fetch_array($ambil, MYSQLI_ASSOC)) {
          ...
          <tr>
            ...
            <td>
              <div align="center">Rp <?php echo number_format($array['Harga'], 0, ',', '.'); ?></div>
            </td>
            <td>
              <div align="center"><?php echo "$array[Stok]"; ?></div>
            </td>
            <td>
              <div align="center"><a href="homekasir.php?pg=formeditproduk&idnya=
<?php echo $array['ProdukId']; ?>">EDIT</a></div>
            </td>
            <td>
              <div align="center"><a href="deleteproduk.php?idnya=<?php echo
                $array['ProdukId']; ?>" onclick="return confirm('Yakin akan dihapus?')">
                  HAPUS</a></div>
            </td>
          </tr>
          <?php
